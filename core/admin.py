...
class ProfileAdmin(admin.ModelAdmin):
    list_display = ("id", "name", "account", "gold_balance", "created_at")
...
class TagAdmin(admin.ModelAdmin):
    list_display = ("id", "name", "profile", "is_system", "created_at")
...
class ChecklistItemAdmin(admin.ModelAdmin):
    list_display = ("id", "text", "task", "is_completed", "sort_order", "created_at")
...
class StreakBonusRuleAdmin(admin.ModelAdmin):
    list_display = ("id", "task", "streak_goal", "bonus_percent", "created_at")
    list_filter = ("created_at",)
...
class LogEntryAdmin(admin.ModelAdmin):
    list_display = ("id", "type", "profile", "task", "reward", "gold_delta", "user_gold", "timestamp", "created_at")
